    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 list-number">
          ...
          <h2 class="textAlign-center pt20 text-upper">Colleges under GSHEC</h2>
          <hr class="title_tag">
          <!-- <ul class="p_inner_div"> -->
            ...
            ?>
          <!-- </ul> -->
          <iframe style="padding: 20px 100px;" src="https://www.google.com/maps/d/embed?mid=1cfp_L5XbgNGrltfQMVvCDrXInicZwxE&ehbc=2E312F" width="100%" height="880"></iframe>
        </div>
      </div>
    </div>
  </section>
