...
<?php 
  ...
  include 'data/research_dev_innovation_activity.php';
?>
<style>
            ...
            <div class="row">
              <div class="col-md-7">
                <p class="p0 mb_0 textFont-14">
                  ...
                  at the Directorate of Higher Education, Porvorim Goa. During this workshop, total 51 Librarians/Librarian Grade-I working at Higher Educational Institutes (HEIs) in Goa were provided
                </p>
                <ol class="textFont-14">
                  <li>
