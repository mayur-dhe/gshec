<?php
    ...
    $activities = [
        ...
        array(
            'year_id' => 2,
            'year' => '2023',
            'title' => 'Signing of the MoU between GSHEC, DHE and TCS (AIP), Chennai',
        ),
        array(
            'year_id' => 2,
            'year' => '2023',
            'title' => 'Shiksha Sangam',
        ),
        array(
            'year_id' => 2,
            'year' => '2023',
            'title' => 'INSPIRE  to ASPIRE 2.0',
            'code' => 'inspire_to_aspire_2'
        ),
    ...
    $installation_of_tip = [
        ...
        'data' => array(
                    "Skill development and providing employment opportunities are some of the  objectives under the National Education Policy 2020.  Thus requiring strengthening of  Industry – Academia collaborations to skill and train students from all Higher Education Institutes accross Goa thereby making them Industry ready. The Goa State Higher Education Council and Directorate of Higher Education, Government of Goa installed a cell called “Training, Internship and Placement (TIP)” to execute all the future functions carried out as an outcome of Industry - Academia collaborations. ",
                    "The Hon’ble Chief Minister Dr. Pramod Sawant inaugurated the installation of TIP Cell at the Art and Culture Hall on 8th September 2022. ",
                ),
        'list' => array(
    ...
    $placement_drive = [
        ...
        'date' => ' 22nd July 2022',
        'data1' => array(
                    "The Directorate of Higher Education (DHE), in association with Government Colleges of Arts, Science and Commerce (Quepem, Sanquelim and Khandola), centrally organized a job placement drive titled Inspire to Aspire on 22nd July 2022 at Government College, Quepem. Prof Joydeep Bhattacharjee, Principal of Government College, Quepem, along with Prof Vitthal Tilvi and Prof Niyan Marchon from DHE,  Goa State Higher Education Council, were present for the inaugural. Also present were industry representatives such as  Poonam Narvekar from Umang Software, Manjita Velip from Genora Infotech, Milind Anvekar from Open Destinations, Ivo Costa from Creative Capsule, Omkar Prabhu of Zimetrics and Mamatha of Tangentia.",
                    "The drive was inaugurated with the lighting of a lamp. Dr Bhattacharjee, Principal of Government College Quepem, welcomed the gathering. The industry representatives briefly introduced their companies. Prof Marchon and Prof Tilvi moderated a panel discussion with the IT companies present for the placement drive. The discussion focused on meeting the goals of NEP through an academia-industry connection. The speakers also spoke about the initiatives which could be taken to enhance the skills of students so that they could be placement ready by the time they graduate. The session also focused on including internships for the general graduation courses to enhance the work experience amongst the students.",
                    "The Job placement drive was for the BSc. final year students of Computer Science graduating in September 2022 across the state. In addition to students from Computer Science, a few IT companies also agreed to interview students from Physics and Mathematics disciplines, provided they had taken computer science courses during their first and second years of the UG program.",
                    "Around 60 students registered on the day of the placement drive from seven colleges in Goa offering BSc. in Computer Science courses. Out of which, 30 students were placed in various companies.",
                ),
        'list-college' => array(
                    'title'=> "The job placement drive consisted of training, pre-screening tests, interviews and final in-person interviews. Before the placement drive, students were trained in soft skills & resume building at DHE on 18th July 2022. The resource person invited to deliver the sessions was Ms Sarita D’Souza, among others. The training was provided to about 100 students from seven colleges across the state of Goa. The colleges include",
                    'content'=> array(
        ...
        'list-company' => array(
                    'title'=> "The IT companies participating in the drive interviewed the students for positions as software developer trainees, testers, UI/UX developers, analysts, and other jobs. 
                                <br>
        ...
        'data2' => array(
                    "The panellists spoke about the initiatives which could be taken to enhance the skills among students so that students can be industry ready by the time they graduate. The session also focused on including internships for students in general graduation education courses to enhance the work experience among the students.",
    ...
    $tcs_drive = [
        ...
        'data' => array(
                    "Goa State Higher Education Council (GSHEC) and Directorate of Higher Education (DHE), in association with Government College of Commerce and Economics, Borda, Margao-Goa, organised a Job Placement Drive in collaboration with Tata Consultancy Services (TCS) Mumbai for all B.Com, B.Sc and BA students who had graduated in 2021 and 2022. The placement drive was conducted on 5th November 2022 between 9:30 am to 1:30 pm.",
                    "The Drive started with the inauguration ceremony at 10 am. in the College Seminar Hall. Mr Shailendra Mehta and Mr Arindam, HR Managers, along with Ms Disha Terkar and Ms Reshma Bachwani, Campus Recruiters, were representatives from TCS. Prof. Niyan Marchon, Teaching, Learning, and Education Technology at the State Higher Education Council, Directorate of Higher Education, Dr Elizabeth Henriques, Principal In-charge and Dr Maria Fatima D’Souza, Convenor, Placement Cell, were also present for the inauguration ceremony.",
                    "Asst. Prof. Riva Paes was the compere for the function. Dr Elizabeth Henriques gave the introductory note while Asst. Prof. Dr Monica Patil introduced the guests who were present for the ceremony. Mr Arindam spoke about the recruitment by TCS and motivated the candidates. Dr Niyan Marchon spoke about the importance of Job Placements happening in colleges. The Inaugural function ended with the Vote of Thanks by Dr Maria Fatima D’Souza.",
                    "A total of 17 representatives were present from TCS for the Placement Drive. The placement drive consisted of two rounds; the first round was the interview round, and those who cleared the first round were made to give a pen-and-paper test in the second round. A total of 84 candidates answered the interviews, out of which 26 students were shortlisted. Mr Aaron Pereira, Director of Physical Education, coordinated the entire programme",
                ),
    ];
    // unlu
        // data  
    ...
    $unlu = [
        ...
        'data1' => array(
                    "The Directorate of Higher Education and Goa State Higher Education Council, Government of Goa, in association with Mugafi, also referred to as Unlu, organized a launch event on 27th February 2023 at Entertainment Society of Goa, Panaji titled “Creators Connect”. The launch event was an initiative of an MOU between the Goa State Higher Education Council (GSHEC), Directorate of Higher Education (DHE), Government of Goa and Unlu which was signed in October 2022. Renowned artists from the Indian film industry were eminent speakers at the event. A total of 350 students from 40 Higher Education Institutes across the State of Goa attended the program.",
                    "The launch event started with an Inaugural function. Asst. Prof. Tanvi Bambolkar was the compere for the Inaugural programe. The compere welcomed the Additional Director of Directorate of Higher Education, Prof Gervasio Mendes, Coordinator of the event and Professor of Teaching, Learning & Educational Technology Section, Goa State Higher Education Council - Prof. Niyan Marchon and CEO of Mugafi – Mr Vipul Agarwal and other distinguished guests from the industry Mr Prashant Pandey, Mr Sumrit Shahi, Mr Akshay Johar, Ms Raagini Kavathekar, Mr Dony Hazarika.  The event started with the screening of the Mugafi (Unlu) Fellowship Showreel.",
                    "Additional Director of the Directorate of Higher Education, Prof Gervasio Mendes, welcomed the distinguished guest, faculty and students present. He highlighted the essence of such programs for artists and musicians in the present day apart from the regular degree-granting courses.",
        ...
        'list' => array(
            ...
            'content'=> array(
                        "Prashant Pandey - one of India's leading screenwriters who has penned films like Sarkar Raj, Raktacharitra & Poorna.",
                        "Sumrit Shahi - one of India's bestselling author, screenwriter and speaker. He has written three books, over 1500 episodes for Indian television and 10 web series in the capacity of story, screenplay and dialogue writer.",
                        "Raagini Kavathekar - an Indian Playback Singer who has sung songs for numerous Marathi Films like Sarva Line Vyasta Ahe, Gadbad Jhaali, Nishkarsh and TV Series such as Jai Maa Durge, Mahabharat, Mata ki Chowki and many more.",
                        "Dony Hazarika - a Music Composer and Music Producer best known for his album ‘Bohnimaan..The Folk Flows’.",
                    ),
            ),
        'data2' => array(
                    "The panel discussion was moderated by Mr Sushant Kaushik, who is associated with Mugafi. The group discussion with both writers and musicians was a very fruitful one where many doubts about students’ making it to the national and international stages were cleared. Students were shown a clear path that could help them achieve great success. They were made aware of how upskilling, collaborating, and networking could add to the exponential growth of an individual in this industry. ",
                    "The group discussion was followed by lunch which was later followed by an open mic session wherein 25 students were allowed to perform in front of professionals and peers. Once again, the screening of the Mugafi (Unlu) and DHE Fellowship Showreel was held.",
                    "The valedictory function started with the screening of an audio-visual message from the Hon’ble Chief Minister of Goa, Dr Pramod Sawant, who encouraged every student to follow their passion for art and music. He stated that if they put in hard work and took calculated risks, they could easily make their hobby a profession that could yield good returns and make them very successful. He also spoke about the different initiatives being carried out by the Government of Goa in line with the objectives of National Education Policy 2020. The valedictory function ended with a vote of thanks by Professor of Teaching, Learning & Educational Technology Section, Goa State Higher Education Council - Prof. Niyan Marchon.",
                ),
    ];
    // $newton = [    
        // 'data1' => 
    ...
    $newton = [
        ...
        'data1' => array(
                    "The Goa State Higher Education Council, the Directorate of Higher Education, Government of Goa collaborated with Newton School to organize the Digital Goa Youth Summit (DGYS) in the presence of several luminaries. The event was held at Dr Shyama Prasad Mukherjee Stadium, Taleigao Plateau, on 28th March 2023, which also marked the launch of the Digital Goa Scholarship Program, which was initiated in October 2022. The program aimed to create a talented pool of tech professionals in Goa in collaboration with Newton School.",
                    "The event started with an Inaugural function hosted by Radio Jockey - RJ Devanggana Chauhan. The compere welcomed the Chief Guest for the event Hon’ble Chief Minister Dr. Pramod Sawant, Secretary of Education, Shri S S Gill – IAS, Shri. Prasad Lolayekar, IAS  -  Director of Directorate of Higher Education and Executive Director of Goa State Higher Education Council, Prof. Niyan Marchon, Professor of Teaching, Learning & Educational Technology section, Goa State Higher Education Council,  founders of Newton School, Siddharth Maheshwari and Nishant Chandra and another distinguished guest graced the event with their presence. The event started with the screening of the Directorate of Higher Education Showreel as well as the Newton School Showreel.",
                    "Hon’ble Chief Minister Dr Pramod Sawant stated that he was happy that Goa State Higher Education Council, Directorate of Higher Education, Government of Goa, in collaboration with Newton School, was launching this scholarship program aimed at enabling Goan students to become tech experts. He stated that this scholarship will provide students with access to courses that will enhance their skills and make them industry-ready, thus enabling them to contribute to the state as well as to our nation. He stated that the summit would enable over 5,000 students from across the state of Goa to discuss the latest trends and opportunities in the tech industry to envision the future of their tech careers. He also encouraged the students in Goa to take up entrepreneurship as a career option and stated those interested in government jobs would have to get through by clearing the state staff selection examination.",
                    "The Director of the Directorate of Higher Education, also holding charge as the Executive Director of the Goa State Higher Education Council – Shri Prasad Loleyekar, IAS, welcomed the faculty and student participants and thanked the respective principals of their institution for deputing them. He shared his insights about the various initiatives taken by the Directorate of Higher Education in line with the objectives of the National Education Policy 2020. He spoke about how this MOU would help tap the undiscovered talent within the state of Goa and how our students could hone their skills in the tech industry.",
                    "The founders of Newton School, Mr Siddharth Maheshwari and Mr Nishant Chandra, IIT Roorkee graduates, addressed the gathering together. They spoke about the vision of Newton School in bridging the gap between learners and jobs. They spoke about the primary focus on skill-oriented and industry-focused tech courses for students and working professionals, which would help them get placed as software developers and engineers, with their 2000+ hiring partners including companies such as Google, Zomato, Thoughtworks, Xiaomi, Flipkart, Deloitte, Meesho, and TCS.",
                    ...
                    "Upon successful completion of the boot camp, selected students would be enrolled in its flagship 6-month long full stack development course free of cost and learn from industry experts hailing from Google, Microsoft, and Amazon, among others, with added focus on one-on-one training and mentorship. Students were assured of 100 percent placement assistance to skyrocket their tech careers with their over 2000+ hiring partners.",
                    "Prof. Niyan Marchon, Professor of Teaching, Learning & Educational Technology section, Goa State Higher Education Council, gave the vote of thanks for the inaugural function. He thanked the Hon’ble Chief Minister of Goa, Dr Pramod Sawant and Secretary of Education, Shri S S Gill, for always extending their full support for organizing such programs in the interest of our Goan students.",
                    "The event started with key speakers and panellists from various sectors across the tech industry addressing the students about ways to start their careers and the various opportunities in the tech sector that lie before them. The event also saw entertainment performances from students of selected Higher Education Institutions in Goa as well popular social media influencer Ms Sukriti Chaturvedi.",
                ),
        'list' => array(
    ...
    $mou_signing_DHE_GSHEC = [
        'title' => 'Signing of the MoU between GSHEC, DHE and TCS (AIP), Chennai',
        'date' => ' 31st March 2023',
        'data1' => array(
                    "The Academic Interface Program (AIP) by Tata Consultancy Services is one of their activities under CSR and has been institutionalized with defined processes, performance metrics and deployment structure. This has facilitated a robust, high-quality, long-term relationship between TCS and Academia which has helped improve the skills and employability of students in India. Goa State Higher Education Council signed an MoU with TCS, Chennai, on 31st March 2023 in the Directorate of Higher Education, Porvorim, Goa. Shri Prasad Lolayekar IAS, Director of DHE, signed on behalf of GSHEC and DHE, while Dr Suceendran K - Global Head - Academic Alliances / Academic Interface Program of TCS, signed on behalf of TCS. Mr Ravikumar Murthy - Region Head - Academic Interface Program and Prof (Dr.) Niyan Marchon, GSHEC were also present at the MoU signing ceremony.",
                ),
    ];
    $shiksha_sangam = [
        'title' => 'Shiksha Sangam: Skilling for a last mile',
        'date' => ' ',
        'data' => array(
                    "The Training, Internship and Placement (TIP) Cell of Goa State Higher Education Council (GSHEC)   and Directorate of Higher Education (DHE) had coordinated an event titled “Shiksha Sangam: Skilling for a last mile” in the presence of Chief Guest Hon’ble Chief Minister of Goa – Dr. Pramod Sawant and other eminent personalities on 24 th April, 2023 at 3.00 p.m. at Institute Menezes Braganza Hall in Panjim, Goa.",
                    "At the event a brochure was released at the hands of the Hon'ble CM which showcased all the initiatives and  activities conducted by Goa State Higher Education Council (GSHEC), Directorate of Higher Education (DHE) , Directorate of Skill Development and Entrepreneurship, Directorate of Technical Education (DTE) and State Council of Educational Research and Training (SCERT).",
                    "The brochure was designed and compiled by the GSHEC team.",
                ),
    ];
    $inspire_to_aspire_2 = [
        'title' => 'INSPIRE  to ASPIRE 2.0',
        'subtitle' => array( 
                        'Training, Internship and Placement (TIP) Cell,',
                        'Goa State Higher Education Council (GSHEC) & Directorate of Higher Education (DHE) ',
        ...
        'data1_img_url' => 'assets/images/tip/2023_inspire_to_aspire_2/collage_north.jpeg',
        'data1_img_caption' => 'Photographs of the TCS Placement drive held at SS Dempo College of Commerce and Economics.',
        // data 2 
        'data2_title' => 'B) Sub report of the South Goa Centre : ',
        'data2_subtitle' => 'VVMs Shree Damodar College of Commerce & Economics, Margao  [26th May 2023]',
        'data2' => array(
                    "The inaugural ceremony was attended by Prof. (Dr.) Niyan Marchon, Teaching, Learning and Education Technology, GSHEC and Main coordinator of the Placement Drive. Ms. Disha Terkar, HR Talent Acquisition Group, Mumbai. Ms. Uttara Nair, Campus Lead, Mumbai. Prof Prita D. Mallya, Principal of VVM's Shree Damodar College of Commerce and Economics. Dr. Anjali Sajilal, Training Internship and Placement Coordinator Shree Damodar College. Dr. Anson Albuquerque and Ms Vandana Sawant ( DHE Coordinator)",
                ),
        'data2_img_url' => 'assets/images/tip/2023_inspire_to_aspire_2/collage_south.jpeg',
        'data2_img_caption' => 'Photographs of the TCS Placement drive held at Shree Damodar College , Margao.',
    ];
    ...
    $tip_images = [
        ...
        // 5 Placement Drive
            array(
                ...
                'url' => 'assets/images/tip/2022_placement_drive/img (1).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'placement_drive',
                'url' => 'assets/images/tip/2022_placement_drive/img (2).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'placement_drive',
                'url' => 'assets/images/tip/2022_placement_drive/img (3).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'placement_drive',
                'url' => 'assets/images/tip/2022_placement_drive/img (4).jpg',
                'alt' => '',
            ),
        // 6 TCS Drive
            array(
        ...
        // 8 Newton
            array(
                'type' => 'newton',
                'url' => 'assets/images/tip/newton/img1.jpg',
                'alt' => '',
            ),
            array(
                'type' => 'newton',
                'url' => 'assets/images/tip/newton/img2.jpg',
                'alt' => '',
            ),
            array(
                'type' => 'newton',
                'url' => 'assets/images/tip/newton/img3.jpg',
                'alt' => '',
            ),
            array(
                'type' => 'newton',
                'url' => 'assets/images/tip/newton/img4.jpg',
                'alt' => '',
            ),
        // 9 mou_signing_DHE_GSHEC
            array(
                'type' => 'mou_signing_DHE_GSHEC',
                'url' => 'assets/images/tip/2023_mou_signing_DHE_GSHEC/img (1).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'mou_signing_DHE_GSHEC',
                'url' => 'assets/images/tip/2023_mou_signing_DHE_GSHEC/img (2).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'mou_signing_DHE_GSHEC',
                'url' => 'assets/images/tip/2023_mou_signing_DHE_GSHEC/img (3).jpg',
                'alt' => '',
            ),
        // 10 shiksha_sangam
            array(
                'type' => 'shiksha_sangam',
                'url' => 'assets/images/tip/2023_shiksha_sangam/img (1).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'shiksha_sangam',
                'url' => 'assets/images/tip/2023_shiksha_sangam/img (2).jpg',
                'alt' => '',
            ),
            array(
                'type' => 'shiksha_sangam',
                'url' => 'assets/images/tip/2023_shiksha_sangam/img (3).jpeg',
                'alt' => '',
            ),

        // 11 inspire_to_aspire_2
            array(
                'type' => 'inspire_to_aspire_2',
                'url' => 'assets/images/tip/2023_inspire_to_aspire_2/collage_north.jpeg',
                'alt' => '',
            ),
            array(
                'type' => 'inspire_to_aspire_2',
                'url' => 'assets/images/tip/2023_inspire_to_aspire_2/collage_south.jpeg',
                'alt' => '',
            ),
        ...
        // 10 (type)
            // array(
            //     'type' => 'type',
            //     'url' => 'assets/images/tip/2023_newton/img1.jpg',
            //     'alt' => '',
            // ),
        // 10 (type)
            // array(
