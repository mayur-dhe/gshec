      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="row text-align-justify sub-title-font pt_30_for_h5 pl_40_for_row textColor-black">
            ...
            <h5 class="col-md-10">2. Karnataka’s State Scholarship Portal (SSP) covering 12 post-matric schemes to be adopted in toto.</h5>
            <div class="row">
            ...
            <h5 class="col-md-10">3. Industry-Internship Portal to be adopted (Andhra Pradesh)</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">4. Faculty positions in colleges to be filled up completely.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">5. NAAC accreditations to be a must – link grants. 100% done in J&K. Order issued in AP – Mentor-mentee linkage established.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">6. Regular Principals in all colleges to be there by March, 2023 latest.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">7. Minimum Common Syllabus in UP for 74 subjects – replicate to assure minimum standards</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">8. Optional Skill system embedded in degree (ref. J&K)</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">9. Institutional Development Plans (IDPs) to be framed by all HEIs by March, 2023.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">10. Internships to be made compulsory in all Polytechnics as in Karnataka.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">11. Replicate upgradation of all ITIs through CSR as done in Karnataka  through its partnership with Tata Technologies Ltd. (Govt. funding was 20% approx)</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">12. Internships to be made mandatory component of curriculum in technical courses.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
            ...
            <h5 class="col-md-10">13. DRONE Policy of Himachal Pradesh to be studied for replication. DRONE policy is being framed by the Civil Aviation Department, Govt. of Goa.</h5>
            <div class="row">
              <div class="col-12 col-md-8 col-lg-7">
